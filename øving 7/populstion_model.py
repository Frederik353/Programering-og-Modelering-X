...
def logistic_model(t_0, t_end,L,k, forkyvining):
    results = [p_0]
    print(type(results))
    a = 0
    b = a + 150
...
model_y = logistic_model(x[0], 2100 ,  L, k)
...
plt.plot(x[71:], un_y[71:], c="y", linestyle ="dashed", label="UN prediction", linewidth=1)
